...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if (cursor.moveToFirst()) {
            mPetId = cursor.getInt(cursor.getColumnIndex(PetContract.PetEntry._ID));
            ...
            mWeightEditText.setText(Integer.toString(cursor.getInt(cursor.getColumnIndex(PetContract.PetEntry.COLUMN_PET_WEIGHT))));
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mGenderSpinner.setSelected(false);
        mWeightEditText.setText("");

    }
    //Creates the discard dialogue
    ...
    //For checking for changes when backbutton pressed
    @Override
    ...
    //For hiding delete option in add a pet activity
    @Override
    ...
    private void deletePet() {
        ...
        int delConfirm = getContentResolver().delete(currentPetUri, PetContract.PetEntry._ID,selectionArgs);
        if(delConfirm != 0){
